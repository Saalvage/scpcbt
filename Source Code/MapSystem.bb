...
Dim MapTemp%(ZONE_AMOUNT, MapWidth+1, MapHeight+1)
Dim MapFound%(ZONE_AMOUNT, MapWidth+1, MapHeight+1)
			...
			If r\grid\grid[x+(y*gridsz)]>0 Then
				...
				Select r\grid\grid[x+(y*gridsz)]
					...
					Case ROOM3,ROOM4
						AddLight%(Null,r\x+x*2.0, 8.0+(412.0*RoomScale), r\z+y*2.0, 2, 500.0 * RoomScale, 255, 255, 255)
					Case ROOM4+1
						dr=CreateDoor(r\zone,r\x+(x*2.0)+(Cos(EntityYaw(tile_entity,True))*240.0*RoomScale),r\y+8.0,r\z+(y*2.0)+(Sin(EntityYaw(tile_entity,True))*240.0*RoomScale),EntityYaw(tile_entity,True)+90.0,Null,False,3,False,"")
					...
					Case ROOM4+2
						...
						it = CreateItem("nvg",r\x+x*2.0-(Sin(EntityYaw(tile_entity,True))*504.0*RoomScale)+(Cos(EntityYaw(tile_entity,True))*16.0*RoomScale), 8.0+(80.0*RoomScale), r\z+y*2.0+(Cos(EntityYaw(tile_entity,True))*504.0*RoomScale)+(Sin(EntityYaw(tile_entity,True))*16.0*RoomScale))
						EntityType (it\collider, HIT_ITEM)
				End Select
...
Function FillRoom(r.Rooms)
	...
	Select r\RoomTemplate\Name
		...
		Case "lockroom"
			...
			PositionEntity(d\buttons[0], r\x - 288.0 * RoomScale, r\y + 0.7, r\z - 640.0 * RoomScale)
			...
			PositionEntity(d2\buttons[0], r\x + 640.0 * RoomScale, r\y + 0.7, r\z + 288.0 * RoomScale)
			...
			Local em.Emitters = CreateEmitter(r\x - 175.0 * RoomScale, r\y + 370.0 * RoomScale, r\z + 656.0 * RoomScale, 0)
		...
		Case "lockroom2"
			...
			For i = 0 To 5
				de.Decals = CreateDecal(Rand(2,3), r\x+Rnd(-392,520)*RoomScale, r\y+3.0*RoomScale+Rnd(0,0.001), r\z+Rnd(-392,520)*RoomScale,90,Rnd(360),0)
				de\Size = Rnd(0.3,0.6)
				ScaleSprite(de\obj, de\Size,de\Size)
				CreateDecal(Rand(15,16), r\x+Rnd(-392,520)*RoomScale, r\y+3.0*RoomScale+Rnd(0,0.001), r\z+Rnd(-392,520)*RoomScale,90,Rnd(360),0)
				de\Size = Rnd(0.1,0.6)
				ScaleSprite(de\obj, de\Size,de\Size)
				CreateDecal(Rand(15,16), r\x+Rnd(-0.5,0.5), r\y+3.0*RoomScale+Rnd(0,0.001), r\z+Rnd(-0.5,0.5),90,Rnd(360),0)
				de\Size = Rnd(0.1,0.6)
				ScaleSprite(de\obj, de\Size,de\Size)
			Next
		...
		Case "gateaentrance"
			...
			;alempi hissi
			r\RoomDoors[0] = CreateDoor(0, r\x+744.0*RoomScale, r\y, r\z+512.0*RoomScale, 90, r, True, 3)
			...
			r\RoomDoors[1] = CreateDoor(r\zone, r\x, r\y, r\z - 360.0 * RoomScale, 0, r, False, True, 5)
			...
			PositionEntity(r\RoomDoors[1]\buttons[0], r\x, r\y + 20.0, r\z, True)
		...
		Case "gateb"
			...
			r\RoomDoors[4] = CreateDoor(r\zone, r\x, r\y, r\z - 320.0 * RoomScale, 0, r, False, True, 5)
			r\RoomDoors[4]\dir = 1 : r\RoomDoors[4]\AutoClose = False : r\RoomDoors[4]\open = False
			PositionEntity(r\RoomDoors[4]\buttons[1], r\x+352*RoomScale, r\y+0.7, r\z-528*RoomScale, True)
			RotateEntity r\RoomDoors[4]\buttons[1],0,r\angle-90,0,True
			PositionEntity(r\RoomDoors[4]\buttons[0], r\x, r\y+7.0, r\z, True)		
			...
			r\RoomDoors[3] = CreateDoor(0, r\x+4352.0*RoomScale, r\y+10784.0*RoomScale, r\z+500.0*RoomScale, 0, r, False)
			...
			;"valvomon" etuovi
			d.Doors = CreateDoor(0, r\x+3072.0*RoomScale, r\y+9856.0*RoomScale, r\z+5800.0*RoomScale, 90, r, False, False, 3)
			...
			;PositionEntity(r\Objects[18], r\x+3727.0*RoomScale, r\y+10066.0*RoomScale, r\z+6623.0*RoomScale, True)
		...
		Case "room2testroom2"
			...
			PositionEntity(r\Objects[1], r\x - 669.0 * RoomScale, r\y + 0.5, r\z - 16.0 * RoomScale) ;r\x - 632
			...
			r\RoomDoors[0] = CreateDoor(r\zone, r\x - 240.0 * RoomScale, r\y, r\z + 640.0 * RoomScale, 90, r, False, False, 1)
			...
			it = CreateItem("nav300", r\x - 312.0 * RoomScale, r\y + 264.0 * RoomScale, r\z + 176.0 * RoomScale)
		...
		Case "room2toilets"
			...
			r\Objects[1] = CreatePivot()
			;PositionEntity(r\Objects[1], r\x + 1270.0*RoomScale, r\y + 0.5, r\z+570.0*RoomScale)
		...
		Case "room2storage"
			...
			it = CreateItem("emptycup", r\x-672*RoomScale, r\y + 240*RoomScale, r\z+288.0*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2sroom"
			...
			d = CreateDoor(r\zone, r\x + 1440.0 * RoomScale, r\y + 224.0 * RoomScale, r\z + 32.0 * RoomScale, 90, r, False, False, 4)
			d\AutoClose = False : d\open = False
		...
		Case "room2poffices"
			...
			d = CreateDoor(r\zone, r\x + 240.0 * RoomScale, r\y, r\z + 448.0 * RoomScale, 90, r, False, False, 0, Str(AccessCode))
			...
			d = CreateDoor(r\zone, r\x - 496.0 * RoomScale, r\y, r\z, 90, r, False, False, 0, "ABCD")
			...
			d = CreateDoor(r\zone, r\x + 240.0 * RoomScale, r\y, r\z - 576.0 * RoomScale, 90, r, False, False, 0, "7816")
			PositionEntity(d\buttons[0], r\x + 248.0 * RoomScale, EntityY(d\buttons[0],True), EntityZ(d\buttons[0],True),True)
			PositionEntity(d\buttons[1], r\x + 232.0 * RoomScale, EntityY(d\buttons[1],True), EntityZ(d\buttons[1],True),True)		
			d\AutoClose = False : d\open = False	
			...
			EntityParent(it\collider, r\obj)
			it = CreateItem("paper", r\x + 912 * RoomScale, r\y + 176.0 * RoomScale, r\z - 160.0 * RoomScale, "journal")
			EntityParent(it\collider, r\obj)
		...
		Case "room2poffices2"
			...
			r\RoomDoors[0] = CreateDoor(r\zone, r\x - 432.0 * RoomScale, r\y, r\z, 90, r, False, False, 0, "1234")
		...
		Case "room2cafeteria"
			...
			;scp-294
			r\Objects[0] = CreatePivot(r\obj)
			PositionEntity(r\Objects[0], r\x+1847.0*RoomScale, r\y-240.0*RoomScale, r\z-321*RoomScale, True)
			;"spawnpoint" for the cups
			r\Objects[1] = CreatePivot(r\obj)
			PositionEntity(r\Objects[1], r\x+1780.0*RoomScale, r\y-248.0*RoomScale, r\z-276*RoomScale, True)
			
			it = CreateItem("cup", r\x-508.0*RoomScale, r\y-187*RoomScale, r\z+284.0*RoomScale, "", 240,175,70)
			EntityParent(it\collider, r\obj) : it\localname = GetLocalString("Items", "orangecup")
			
			it = CreateItem("cup", r\x+1412 * RoomScale, r\y-187*RoomScale, r\z-716.0 * RoomScale, "", 87,62,45)
			EntityParent(it\collider, r\obj) : it\localname = GetLocalString("Items", "coffeecup")
			
			it = CreateItem("emptycup", r\x-540*RoomScale, r\y-187*RoomScale, r\z+124.0*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2nuke"
			...
			it = CreateItem("paper", r\x - 768.0 * RoomScale, r\y + 1684.0 * RoomScale, r\z - 768.0 * RoomScale, "document")
			EntityParent(it\collider, r\obj)
		...
		Case "room2tunnel"
			...
			r\RoomDoors[0]\AutoClose = False : r\RoomDoors[0]\open = True
			PositionEntity(r\RoomDoors[0]\buttons[1], r\x + 224.0 * RoomScale, r\y + 0.7, r\z + 480.0 * RoomScale, True)
			PositionEntity(r\RoomDoors[0]\buttons[0], r\x + 304.0 * RoomScale, r\y + 0.7, r\z + 832.0 * RoomScale, True)			
			
			r\RoomDoors[2] = CreateDoor(r\zone, r\x - 264.0 * RoomScale, r\y, r\z - 656.0 * RoomScale, 90, r, True, 3)
			r\RoomDoors[2]\AutoClose = False : r\RoomDoors[2]\open = True
			PositionEntity(r\RoomDoors[2]\buttons[0], r\x - 224.0 * RoomScale, r\y + 0.7, r\z - 480.0 * RoomScale, True)
			PositionEntity(r\RoomDoors[2]\buttons[1], r\x - 304.0 * RoomScale, r\y + 0.7, r\z - 832.0 * RoomScale, True)
			...
			de.Decals = CreateDecal(0, r\x + 64.0 * RoomScale, r\y + 0.005, r\z + 144.0 * RoomScale, 90, Rand(360), 0)
			EntityParent(de\obj, r\obj)
		...
		Case "room035"
			...
			r\RoomDoors[2] = CreateDoor(r\zone, r\x + 384.0 * RoomScale, r\y, r\z - 672.0 * RoomScale, 180, r, False, 0, 5)
			...
			;the control room
			r\Objects[3] = CreatePivot(r\obj)
			PositionEntity(r\Objects[3], r\x + 456 * RoomScale, r\y + 0.5, r\z + 400.0 * RoomScale, True)
			...
			r\Objects[7] = CreatePivot(r\obj)
			PositionEntity(r\Objects[7], r\x - 720 * RoomScale, r\y + 0.5, r\z + 880.0 * RoomScale, True)
			r\Objects[8] = CreatePivot(r\obj)
			PositionEntity(r\Objects[8], r\x + 176 * RoomScale, r\y + 0.5, r\z - 144.0 * RoomScale, True)			
			...
			it = CreateItem("scp500", r\x + 1168*RoomScale, r\y + 224*RoomScale, r\z+576*RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("scp148", r\x - 360 * RoomScale, r\y + 0.5, r\z + 644 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("paper", r\x + 1168.0 * RoomScale, r\y + 104.0 * RoomScale, r\z + 608.0 * RoomScale, "d035")
			EntityParent(it\collider, r\obj)
		...
		Case "room966"
			...
			d = CreateDoor(r\zone, r\x - 400.0 * RoomScale, r\y, r\z, -90, r, False, False, 3)
			d = CreateDoor(r\zone, r\x, r\y, r\z - 480.0 * RoomScale, 180, r, False, False, 3)
			;: d\buttons[0] = False
			;PositionEntity (d\buttons[0], EntityX(d\buttons[0],True), EntityY(d\buttons[0],True), r\z + 288.0 * RoomScale, True)
			;PositionEntity (d\buttons[1], EntityX(d\buttons[1],True), EntityY(d\buttons[1],True), r\z + 320.0 * RoomScale, True)
			...
			r\Objects[1] = CreatePivot(r\obj)
			PositionEntity(r\Objects[1], r\x + 64.0 * RoomScale, r\y + 0.5, r\z - 640.0 * RoomScale, True)
			
			r\Objects[2] = CreatePivot(r\obj)
			PositionEntity(r\Objects[2], r\x, r\y + 0.5, r\z, True)
			
			r\Objects[3] = CreatePivot(r\obj)
			PositionEntity(r\Objects[3], r\x + 320.0 * RoomScale, r\y + 0.5, r\z + 704.0 * RoomScale, True)
		...
		Case "room3storage"
			...
			r\Objects[3] = CreatePivot(r\obj)
			;PositionEntity(r\Objects[3], r\x + 720.0 * RoomScale, r\y-5392.0 * RoomScale, r\z + 752.0 * RoomScale, True)
			...
			r\RoomDoors[0]\AutoClose = False : r\RoomDoors[0]\open = True
			PositionEntity(r\RoomDoors[0]\buttons[1], r\x - 160.0 * RoomScale, r\y + 0.7, r\z + 480.0 * RoomScale, True)
			PositionEntity(r\RoomDoors[0]\buttons[0], r\x + 160.0 * RoomScale, r\y + 0.7, r\z + 416.0 * RoomScale, True)	
			...
			r\RoomDoors[2] = CreateDoor(r\zone, r\x + 608.0 * RoomScale, r\y, r\z - 312.0 * RoomScale, 0, r, True, 3)
			r\RoomDoors[2]\AutoClose = False : r\RoomDoors[2]\open = True
			PositionEntity(r\RoomDoors[2]\buttons[1], r\x + 448.0 * RoomScale, r\y + 0.7, r\z - 272.0 * RoomScale, True)	
			PositionEntity(r\RoomDoors[2]\buttons[0], r\x + 768.0 * RoomScale, r\y + 0.7, r\z - 352.0 * RoomScale, True)
			
			;r\RoomDoors[3] = CreateDoor(r\zone, r\x + 720.0 * RoomScale,  r\y-5632.0 * RoomScale, r\z + 1064.0 * RoomScale, 0, r, False)
			...
			em.Emitters = CreateEmitter(r\x + 5218.0 * RoomScale, r\y-5584.0*RoomScale, r\z - 600* RoomScale, 0)
			...
			it.Items = CreateItem("hand2", r\x + x*RoomScale, r\y-5596.0*RoomScale+1.0, r\z+z*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room049"
			...
			r\RoomDoors[0] = CreateDoor(r\zone, r\x + 330.0 * RoomScale, r\y, r\z + 656.0 * RoomScale, 90, r, True, 3)
			r\RoomDoors[0]\AutoClose = False : r\RoomDoors[0]\open = True
			PositionEntity(r\RoomDoors[0]\buttons[1], r\x + 288.0 * RoomScale, r\y + 0.7, r\z + 512.0 * RoomScale, True)
			PositionEntity(r\RoomDoors[0]\buttons[0], r\x + 368.0 * RoomScale, r\y + 0.7, r\z + 840.0 * RoomScale, True)
			
			r\RoomDoors[1] = CreateDoor(r\zone, r\x + 2898.0 * RoomScale, r\y-3520.0 * RoomScale, r\z + 1824.0 * RoomScale, 90, r, False, 3)
			r\RoomDoors[1]\AutoClose = False : r\RoomDoors[1]\open = False	
			PositionEntity(r\RoomDoors[1]\buttons[1], r\x + 2881.0 * RoomScale, r\y + 0.7, r\z + 1663.0 * RoomScale, True)
			PositionEntity(r\RoomDoors[1]\buttons[0], r\x + 2936.0 * RoomScale, r\y + 0.7, r\z + 2009.0 * RoomScale, True)				
			
			r\RoomDoors[2] = CreateDoor(r\zone, r\x - 672.0 * RoomScale, r\y, r\z - 408.0 * RoomScale, 0, r, True, 3)
			r\RoomDoors[2]\AutoClose = False : r\RoomDoors[2]\open = True
			PositionEntity(r\RoomDoors[2]\buttons[0], r\x - 487.0 * RoomScale, r\y + 0.7, r\z - 447.0 * RoomScale, True)
			PositionEntity(r\RoomDoors[2]\buttons[1], r\x - 857.0 * RoomScale, r\y + 0.7, r\z - 369.0 * RoomScale, True)				
			
			r\RoomDoors[3] = CreateDoor(r\zone, r\x - 2766.0 * RoomScale, r\y-3520.0 * RoomScale, r\z - 1592.0 * RoomScale, 0, r, False, 3)
			r\RoomDoors[3]\AutoClose = False : r\RoomDoors[3]\open = False		
			PositionEntity(r\RoomDoors[3]\buttons[0], r\x - 2581.0 * RoomScale, r\y + 0.7, r\z - 1631.0 * RoomScale, True)
			PositionEntity(r\RoomDoors[3]\buttons[1], r\x - 2951.0 * RoomScale, r\y + 0.7, r\z - 1553.0 * RoomScale, True)	
			...
			d.Doors = CreateDoor(0, r\x,r\y,r\z, 0, r, False, 2, -2)
		...
		Case "room2_2"
			...
			PositionEntity(r\Objects[0], r\x - 248 * RoomScale, r\y + 528 * RoomScale, r\z, 0)
			EntityParent(r\Objects[0], r\obj)

		Case "room012"

			d.Doors = CreateDoor(r\zone, r\x + 264.0 * RoomScale, r\y, r\z + 672.0 * RoomScale, 270, r, False, False, 3)
			...
			r\RoomDoors[0]\AutoClose = False : r\RoomDoors[0]\open = False : r\RoomDoors[0]\locked = True
			PositionEntity(r\RoomDoors[0]\buttons[0], r\x + 176.0 * RoomScale, r\y-512.0*RoomScale, r\z - 364.0 * RoomScale, True)
			FreeEntity r\RoomDoors[0]\buttons[1] : r\RoomDoors[0]\buttons[1]=0
			...
			PositionEntity(r\Objects[4], r\x - 360 * RoomScale, r\y - 130 * RoomScale, r\z + 456.0 * RoomScale, 0)
			EntityParent(r\Objects[4], r\Objects[2])
			
			it = CreateItem("paper", r\x - 56.0 * RoomScale, r\y - 576.0 * RoomScale, r\z - 408.0 * RoomScale, "d012")
			EntityParent(it\collider, r\obj)
			
			it.Items = CreateItem("hand", r\x - 784*RoomScale, r\y-576*RoomScale+0.3, r\z+640*RoomScale)
			EntityParent(it\collider, r\obj)
			
			de.Decals = CreateDecal(3,  r\x - 784*RoomScale, r\y-768*RoomScale+0.01, r\z+640*RoomScale,90,Rnd(360),0)
			de\Size = 0.5
			ScaleSprite(de\obj, de\Size,de\Size)
			EntityParent de\obj, r\obj
		...
		Case "tunnel2"
			...
			r\Objects[0] = CreatePivot(r\obj)
			PositionEntity(r\Objects[0], r\x, r\y + 544.0 * RoomScale, r\z + 512.0 * RoomScale, True)
			
			r\Objects[1] = CreatePivot(r\obj)
			PositionEntity(r\Objects[1], r\x, r\y + 544.0 * RoomScale, r\z - 512.0 * RoomScale, True)
		...
		Case "room2servers"
			...
			d.Doors = CreateDoor(0, r\x,r\y,r\z, 0, r, False, 2, False)
			d\locked = True
			...
			r\RoomDoors[2] = CreateDoor(r\zone, r\x - 672.0 * RoomScale, r\y, r\z - 1024.0 * RoomScale, 0, r, False, False, False, "GEAR")
			...
			;096 spawnpoint
;			r\Objects[6]=CreatePivot(r\obj)
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, r\y + 0.5, r\z-576*RoomScale, True)
			r\Objects[6]=CreatePivot(r\obj)
			PositionEntity(r\Objects[6],r\x-320*RoomScale,r\y + 0.5,r\z,True)
			;guard spawnpoint
			r\Objects[7]=CreatePivot(r\obj)
			PositionEntity(r\Objects[7], r\x - 1328.0 * RoomScale, r\y + 0.5, r\z + 528*RoomScale, True)
			;the point where the guard walks to
			r\Objects[8]=CreatePivot(r\obj)
			PositionEntity(r\Objects[8], r\x - 1376.0 * RoomScale, r\y + 0.5, r\z + 32*RoomScale, True)
			
			r\Objects[9]=CreatePivot(r\obj)
			PositionEntity(r\Objects[9], r\x - 848*RoomScale, r\y + 0.5, r\z+576*RoomScale, True)
		...
		Case "room3servers"
			...
			r\Objects[0] = CreatePivot(r\obj)
			PositionEntity(r\Objects[0], r\x + 736.0 * RoomScale, r\y-512.0 * RoomScale, r\z - 400.0 * RoomScale, True)
			r\Objects[1] = CreatePivot(r\obj)
			PositionEntity(r\Objects[1], r\x - 552.0 * RoomScale, r\y-512.0 * RoomScale, r\z - 528.0 * RoomScale, True)			
			r\Objects[2] = CreatePivot(r\obj)
			PositionEntity(r\Objects[2], r\x + 736.0 * RoomScale, r\y-512.0 * RoomScale, r\z + 272.0 * RoomScale, True)
			...
			PositionEntity (r\Objects[3], r\x + 928.0 * RoomScale, r\y-640*RoomScale, r\z + 704.0 * RoomScale)
		...
		Case "room2offices3"
			...
			r\RoomDoors[0] = CreateDoor(r\zone, r\x - 1056.0 * RoomScale, r\y + 384.0*RoomScale, r\z + 290.0 * RoomScale, 90, r, True)
			r\RoomDoors[0]\AutoClose = False : r\RoomDoors[0]\open = True
		...
		Case "start"
			...
			d.Doors = CreateDoor(r\zone, r\x + 1280.0 * RoomScale, r\y + 384.0*RoomScale, r\z + 312.0 * RoomScale, 180, r, True)
			d\locked = True : d\AutoClose = False
			...
			PositionEntity(sc\ScrObj, r\x + 1456 * RoomScale, r\y + 608 * RoomScale, r\z +352.0 * RoomScale)
			TurnEntity(sc\ScrObj, 0, 90, 0)
			EntityParent(sc\ScrObj, r\obj)
			
			it = CreateItem("paper", r\x + 435.0 * RoomScale, r\y + 220.0 * RoomScale, r\z + 940.0 * RoomScale, "d173")
			RotateEntity(it\Collider, 0, 100, 0, True)
			EntityParent(it\collider, r\obj)
		...
		Case "room2scps"
			...
			d.Doors = CreateDoor(r\zone, r\x + 264.0 * RoomScale, r\y, r\z, 90, r, True, False, 3)
			d\AutoClose = False : d\open = False
			...
			d.Doors = CreateDoor(r\zone, r\x - 264.0 * RoomScale, r\y, r\z, 270, r, True, False, 3)
			d\AutoClose = False : d\open = False
			PositionEntity(d\buttons[0], r\x - 320.0 * RoomScale, EntityY(d\buttons[0],True), EntityZ(d\buttons[0],True), True)
			PositionEntity(d\buttons[1], r\x - 224.0 * RoomScale, EntityY(d\buttons[1],True), EntityZ(d\buttons[1],True), True)
			
			r\RoomDoors[1] = CreateDoor(r\zone, r\x-560.0 * RoomScale, r\y, r\z - 272.0 * RoomScale, 0, r, True, False, 3)
			r\RoomDoors[1]\AutoClose = False : r\RoomDoors[1]\open = False
			
			r\RoomDoors[2] = CreateDoor(r\zone, r\x + 560.0 * RoomScale, r\y, r\z - 272.0 * RoomScale, 180, r, True, False, 3)
			r\RoomDoors[2]\AutoClose = False : r\RoomDoors[2]\open = False
			
			r\RoomDoors[3] = CreateDoor(r\zone, r\x + 560.0 * RoomScale, r\y, r\z + 272.0 * RoomScale, 180, r, True, False, 3)
			r\RoomDoors[3]\AutoClose = False : r\RoomDoors[3]\open = False
		...
		Case "room895"
			...
			PositionEntity(sc\ScrObj, r\x - 800 * RoomScale, r\y + 288.0 * RoomScale, r\z - 340.0 * RoomScale)
			EntityParent(sc\ScrObj, r\obj)
		...
		Case "room2tesla","room2tesla_lcz","room2tesla_hcz"
			...
			PositionEntity(r\Objects[4], r\x - 32 * RoomScale, r\y + 568 * RoomScale, r\z)
			...
			r\Objects[5] = CreatePivot()
			PositionEntity(r\Objects[5],r\x,r\y,r\z-800*RoomScale)
			EntityParent(r\Objects[5],r\obj)
			
			r\Objects[6] = CreatePivot()
			PositionEntity(r\Objects[6],r\x,r\y,r\z+800*RoomScale)
			EntityParent(r\Objects[6],r\obj)
		...
		Case "room2doors"
			...
			d\AutoClose = False ;: d\buttons[0] = False
			PositionEntity (d\buttons[0], r\x - 832.0 * RoomScale, r\y + 0.7, r\z + 160.0 * RoomScale, True)
			PositionEntity (d\buttons[1], r\x + 160.0 * RoomScale, r\y + 0.7, r\z + 536.0 * RoomScale, True)
			;RotateEntity(d\buttons[1], 0, 90, 0, True)
			
			d2 = CreateDoor(r\zone, r\x, r\y, r\z - 528.0 * RoomScale, 180, r, True)
			d2\AutoClose = False : FreeEntity (d2\buttons[0]) : d2\buttons[0] = 0
			PositionEntity (d2\buttons[1], r\x +160.0 * RoomScale, r\y + 0.7, r\z - 536.0 * RoomScale, True)
			;RotateEntity(d2\buttons[1], 0, 90, 0, True)
		...
		Case "room173"
			...
			r\Objects[4] = CreatePivot()
			PositionEntity (r\Objects[4], EntityX(r\obj) + 700 * RoomScale, r\y + 100.0 * RoomScale, EntityZ(r\obj) + 320.0 * RoomScale)
			...
			de.Decals = CreateDecal(Rand(4, 5), EntityX(r\Objects[5], True), r\y + 0.002, EntityZ(r\Objects[5], True), 90, Rnd(360), 0)
			de\Size = 1.2
			ScaleSprite(de\obj, de\Size, de\Size)
			
			For xtemp% = 0 To 1
				For ztemp% = 0 To 1
					de.Decals = CreateDecal(Rand(4, 6), r\x + 700.0 * RoomScale + xtemp * 700.0 * RoomScale + Rnd(-0.5, 0.5), r\y + Rnd(0.001, 0.0018), r\z + 600 * ztemp * RoomScale + Rnd(-0.5, 0.5), 90, Rnd(360), 0)
					de\Size = Rnd(0.5, 0.8)
			...
			r\RoomDoors[3] = CreateDoor(r\zone, r\x - 2320.0 * RoomScale, r\y, r\z - 1248.0 * RoomScale, 90, r, True)
			...
			r\RoomDoors[7] = CreateDoor(r\zone, r\x - 3712.0 * RoomScale, r\y-385*RoomScale, r\z - 128.0 * RoomScale, 0, r, True)
			r\RoomDoors[7]\AutoClose = False : r\RoomDoors[7]\open = True
			
			d.Doors = CreateDoor(r\zone, r\x - 3712 * RoomScale, r\y-385*RoomScale, r\z - 2336 * RoomScale, 0, r, False)
			d\locked = True : d\DisableWaypoint = True
			
			;the door from the concrete tunnel to the large hall
			d.Doors = CreateDoor(r\zone, r\x - 6864 * RoomScale, r\y, r\z - 1248 * RoomScale, 90, r, True)
			d\AutoClose = False
			d\locked = True
			
			;the door to the staircase in the office room
			d.Doors = CreateDoor(r\zone, r\x - 2432 * RoomScale, r\y, r\z - 1000 * RoomScale, 0, r, False)
			...
			For ztemp = 0 To 1
				d.Doors = CreateDoor(r\zone, r\x - 5760 * RoomScale, r\y, r\z + (320+896*ztemp) * RoomScale, 0, r, False)
				d\locked = True
				d\DisableWaypoint = True
				
				d.Doors = CreateDoor(r\zone, r\x - 8288 * RoomScale, r\y, r\z + (320+896*ztemp) * RoomScale, 0, r, False)
				d\locked = True
				If ztemp = 0 Then d\open = True Else d\DisableWaypoint = True
				
				For xtemp = 0 To 2
					d.Doors = CreateDoor(r\zone, r\x - (7424.0-512.0*xtemp) * RoomScale, r\y, r\z + (1008.0-480.0*ztemp) * RoomScale, 180*(Not ztemp), r, False)
				...
				Next					
				For xtemp = 0 To 4
					d.Doors = CreateDoor(r\zone, r\x - (5120.0-512.0*xtemp) * RoomScale, r\y, r\z + (1008.0-480.0*ztemp) * RoomScale, 180*(Not ztemp), r, False)
					EntityTexture d\obj, tex
					d\locked = True
					FreeEntity d\obj2 : d\obj2=0
					FreeEntity d\buttons[0] : d\buttons[0]=0
			...
			r\Objects[11] = CreatePivot()
			PositionEntity (r\Objects[11], EntityX(r\obj) - 7200.0 * RoomScale, r\y-0.3, EntityZ(r\obj) - 3075.0 * RoomScale)
			EntityParent(r\Objects[11], r\obj)

		Case "room2ccont"

			d = CreateDoor(r\zone, r\x + 64.0 * RoomScale, r\y, r\z + 368.0 * RoomScale, 180, r, False, False, 2)
			d\AutoClose = False : d\open = False
		...
		Case "room1123"
			...
			PositionEntity r\Objects[8], r\x - 272.0 * RoomScale, r\y +  512.0 * RoomScale, r\z + 288.0 * RoomScale,True
			RotateEntity r\Objects[8],0,90,0,True
			ScaleEntity r\Objects[8],45.0*RoomScale,r\y+45.0*RoomScale,80.0*RoomScale,True
			EntityParent r\Objects[8],r\obj
			
			r\Objects[9] =  LoadMesh_Strict("GFX\map\forest\door.b3d")
			PositionEntity r\Objects[9],r\x - 272.0 * RoomScale, r\y + 512.0 * RoomScale, r\z + (288.0-70) * RoomScale,True
			...
			PositionEntity r\Objects[10], r\x - 272.0 * RoomScale, r\y +  512.0 * RoomScale, r\z + 736.0 * RoomScale,True
			...
			PositionEntity r\Objects[11],r\x - 272.0 * RoomScale, r\y + 512.0 * RoomScale, r\z + (736.0-70) * RoomScale,True
			...
			PositionEntity r\Objects[12], r\x - 592.0 * RoomScale, r\y + 512.0 * RoomScale, r\z - 704.0 * RoomScale,True
			...
			PositionEntity r\Objects[13],r\x - (592.0+70.0) * RoomScale, r\y + 512.0 * RoomScale, r\z - 704.0 * RoomScale,True
		...
		Case "room2servers2"
			...
			PositionEntity(d\buttons[1], r\x + 304.0 * RoomScale, EntityY(d\buttons[1],True), r\z + 840.0 * RoomScale, True)	
			TurnEntity d\buttons[1],0,0,0,True
			d.Doors = CreateDoor(r\zone, r\x -512.0 * RoomScale, r\y -768.0*RoomScale, r\z -336.0 * RoomScale, 0, r, False, False, 3)
			d.Doors = CreateDoor(r\zone, r\x -509.0 * RoomScale, r\y -768.0*RoomScale, r\z -1037.0 * RoomScale, 0, r, False, False, 3)
			d.Doors\locked = True
		...
		Case "room2gw","room2gw_b"
			...
			If r\RoomTemplate\Name = "room2gw_b"
				...
				de.Decals = CreateDecal(3,  r\x - 156.825*RoomScale, r\y -37.3458*RoomScale, r\z+121.364*RoomScale,90,Rnd(360),0)
				de\Size = 0.5
				ScaleSprite(de\obj, de\Size,de\Size)
				EntityParent de\obj, r\obj
...
;			RotateEntity r\Objects[21],8.6,-150.0,-5.0
		...
		Case "lockroom3"
			...
			PositionEntity r\Objects[0],r\x+668*RoomScale,r\y+1.1,r\z-96.0*RoomScale,True
...
Function UpdateRooms()
	...
	MapFound(PlayerRoom\zone, Floor(EntityX(PlayerRoom\obj) / 8.0), Floor(EntityZ(PlayerRoom\obj) / 8.0)) = 1
			...
			If PlayerRoom\Adjacent[i]<>Null Then
				If PlayerRoom\AdjDoor[i]<>Null
					...
					ElseIf (Not EntityInView(PlayerRoom\AdjDoor[i]\frameobj,Camera))
						;EntityAlpha(GetChild(PlayerRoom\Adjacent[i]\obj,2),0) ;PLACEONE TODO these 3
					Else
...
Dim MapName$(ZONE_AMOUNT, MapWidth, MapHeight)
Dim MapRoomID%(ROOM4 + 1)
Dim MapRoom$(ZONE_AMOUNT, ROOM4 + 1, 0)
...
Function CreateMap()
	...
	For zone = 0 To 2
		...
		Repeat
			...
			width = Abs(width)
			For i = x To x + width
				MapTemp(zone, Min(i,MapWidth), y) = True
			Next
			...
			For i = 1 To yhallways
				...
				While MapTemp(zone, x2, y - 1) Or MapTemp(zone, x2 - 1, y - 1) Or MapTemp(zone, x2 + 1, y - 1)
					x2=x2+1
				Wend
		...
		For y = 1 To MapHeight - 1
			...
			For x = 1 To MapWidth - 1
				If MapTemp(zone, x, y) > 0 Then
					temp = Min(MapTemp(zone, x + 1, y),1) + Min(MapTemp(zone, x - 1, y),1)
					temp = temp + Min(MapTemp(zone, x, y + 1),1) + Min(MapTemp(zone, x, y - 1),1)			
					If MapTemp(zone, x,y)<255 Then MapTemp(zone, x, y) = temp
					Select MapTemp(zone, x,y)
						Case 1
							Room1Amount[zone]=Room1Amount[zone]+1
						Case 2
							If Min(MapTemp(zone, x + 1, y),1) + Min(MapTemp(zone, x - 1, y),1)= 2 Then
								Room2Amount[zone]=Room2Amount[zone]+1	
							ElseIf Min(MapTemp(zone, x, y + 1),1) + Min(MapTemp(zone, x , y - 1),1)= 2
								Room2Amount[zone]=Room2Amount[zone]+1	
							Else
			...
			For y = 2 To MapHeight - 2
				...
				For x = 2 To MapWidth - 2
					If MapTemp(zone, x, y) = 0 Then
						...
						If (Min(MapTemp(zone, x + 1, y),1) + Min(MapTemp(zone, x - 1, y),1) + Min(MapTemp(zone, x, y + 1),1) + Min(MapTemp(zone, x, y - 1),1)) = 1 Then
							;If Rand(4)=1 Then
							
							If MapTemp(zone, x + 1, y) Then
								x2 = x+1 : y2 = y
							ElseIf MapTemp(zone, x - 1, y)
								x2 = x-1 : y2 = y
							ElseIf MapTemp(zone, x, y+1)
								x2 = x : y2 = y+1	
							ElseIf MapTemp(zone, x, y-1)
								x2 = x : y2 = y-1
							EndIf
							...
							placed = False
							If MapTemp(zone, x2,y2)>1 And MapTemp(zone, x2,y2)<4 Then
								Select MapTemp(zone, x2,y2)
									Case 2
										If Min(MapTemp(zone, x2 + 1, y2),1) + Min(MapTemp(zone, x2 - 1, y2),1)= 2 Then
											Room2Amount[zone]=Room2Amount[zone]-1
											Room3Amount[zone]=Room3Amount[zone]+1
											placed = True
										ElseIf Min(MapTemp(zone, x2, y2 + 1),1) + Min(MapTemp(zone, x2, y2 - 1),1)= 2
											Room2Amount[zone]=Room2Amount[zone]-1
											Room3Amount[zone]=Room3Amount[zone]+1
											placed = True
										EndIf
								...
								If placed Then
									MapTemp(zone, x2,y2)=MapTemp(zone, x2,y2)+1
		...
		If Room4Amount[zone]<1 Then ;we want at least 1 ROOM4
			...
			For y = 2 To MapHeight - 2
				For x = 2 To MapWidth - 2
					If MapTemp(zone, x,y)=3 Then
						Select 0 ;see if adding a ROOM1 is possible
							Case (MapTemp(zone, x+1,y) Or MapTemp(zone, x+1,y+1) Or MapTemp(zone, x+1,y-1) Or MapTemp(zone, x+2,y))
								MapTemp(zone, x+1,y)=1
								temp=1
							Case (MapTemp(zone, x-1,y) Or MapTemp(zone, x-1,y+1) Or MapTemp(zone, x-1,y-1) Or MapTemp(zone, x-2,y))
								MapTemp(zone, x-1,y)=1
								temp=1
							Case (MapTemp(zone, x,y+1) Or MapTemp(zone, x+1,y+1) Or MapTemp(zone, x-1,y+1) Or MapTemp(zone, x,y+2))
								MapTemp(zone, x,y+1)=1
								temp=1
							Case (MapTemp(zone, x,y-1) Or MapTemp(zone, x+1,y-1) Or MapTemp(zone, x-1,y-1) Or MapTemp(zone, x,y-2))
								MapTemp(zone, x,y-1)=1
								temp=1
						End Select
						If temp=1 Then
							MapTemp(zone, x,y)=4 ;turn this room into a ROOM4
		...
		If Room2CAmount[zone]<1 Then ;we want at least 1 ROOM2C
			...
			For y = 3 To MapHeight - 3
				For x = 3 To MapWidth - 3
					If MapTemp(zone, x,y)=1 Then
						Select True ;see if adding some rooms is possible
							Case MapTemp(zone, x-1,y)>0
								If (MapTemp(zone, x,y-1)+MapTemp(zone, x,y+1)+MapTemp(zone, x+2,y))=0 Then
									If (MapTemp(zone, x+1,y-2)+MapTemp(zone, x+2,y-1)+MapTemp(zone, x+1,y-1))=0 Then
										MapTemp(zone, x,y)=2
										MapTemp(zone, x+1,y)=2
										DebugLog "ROOM2C forced into slot ("+(x+1)+", "+(y)+")"
										MapTemp(zone, x+1,y-1)=1
										temp=1
									Else If (MapTemp(zone, x+1,y+2)+MapTemp(zone, x+2,y+1)+MapTemp(zone, x+1,y+1))=0 Then
										MapTemp(zone, x,y)=2
										MapTemp(zone, x+1,y)=2
										DebugLog "ROOM2C forced into slot ("+(x+1)+", "+(y)+")"
										MapTemp(zone, x+1,y+1)=1
							...
							Case MapTemp(zone, x+1,y)>0
								If (MapTemp(zone, x,y-1)+MapTemp(zone, x,y+1)+MapTemp(zone, x-2,y))=0 Then
									...
									EndIf
								EndIf
							Case MapTemp(zone, x,y-1)>0
								If (MapTemp(zone, x-1,y)+MapTemp(zone, x+1,y)+MapTemp(zone, x,y+2))=0 Then
									If (MapTemp(zone, x-2,y+1)+MapTemp(zone, x-1,y+2)+MapTemp(zone, x-1,y+1))=0 Then
										MapTemp(zone, x,y)=2
										MapTemp(zone, x,y+1)=2
										DebugLog "ROOM2C forced into slot ("+(x)+", "+(y+1)+")"
										MapTemp(zone, x-1,y+1)=1
										temp=1
									Else If (MapTemp(zone, x+2,y+1)+MapTemp(zone, x+1,y+2)+MapTemp(zone, x+1,y+1))=0 Then
										MapTemp(zone, x,y)=2
										MapTemp(zone, x,y+1)=2
										DebugLog "ROOM2C forced into slot ("+(x)+", "+(y+1)+")"
										MapTemp(zone, x+1,y+1)=1
		...
		Dim MapRoom$(ZONE_AMOUNT, ROOM4 + 1, MaxRooms)
		
		Select zone
			Case 0
				MapRoom(zone, ROOM1, 0) = "start"	
		...
		For y = MapHeight - 1 To 1 Step - 1
			...
			For x = 1 To MapWidth - 2
				If MapTemp(zone, x, y) > 0
					
					temp = Min(MapTemp(zone, x + 1, y),1) + Min(MapTemp(zone, x - 1, y),1) + Min(MapTemp(zone, x, y + 1),1) + Min(MapTemp(zone, x, y - 1),1)
					
					Select temp ;amount of bordering rooms
						Case 1
							If MapRoomID(ROOM1) < MaxRooms And MapName(zone, x,y) = "" Then
								If MapRoom(zone, ROOM1, MapRoomID(ROOM1)) <> "" Then MapName(zone, x, y) = MapRoom(zone, ROOM1, MapRoomID(ROOM1))	
							EndIf
							
							r = CreateRoom(tempzone, ROOM1, x * 8, zone * -1000, y * 8, MapName(zone, x, y))
							If MapTemp(zone, x, y + 1) Then
								r\angle = 180 
						...
						Case 2
							If MapTemp(zone, x - 1, y)>0 And MapTemp(zone, x + 1, y)>0 Then
								If MapRoomID(ROOM2) < MaxRooms And MapName(zone, x, y) = ""  Then
									If MapRoom(zone, ROOM2, MapRoomID(ROOM2)) <> "" Then MapName(zone, x, y) = MapRoom(zone, ROOM2, MapRoomID(ROOM2))	
								EndIf
								r = CreateRoom(tempzone, ROOM2, x * 8, zone * -1000, y * 8, MapName(zone, x, y))
								If Rand(2) = 1 Then r\angle = 90 Else r\angle = 270
								TurnEntity(r\obj, 0, r\angle, 0)
								MapRoomID(ROOM2)=MapRoomID(ROOM2)+1
							ElseIf MapTemp(zone, x, y - 1)>0 And MapTemp(zone, x, y + 1)>0
								If MapRoomID(ROOM2) < MaxRooms And MapName(zone, x, y) = ""  Then
									If MapRoom(zone, ROOM2, MapRoomID(ROOM2)) <> "" Then MapName(zone, x, y) = MapRoom(zone, ROOM2, MapRoomID(ROOM2))	
								EndIf
								r = CreateRoom(tempzone, ROOM2, x * 8, zone * -1000, y * 8, MapName(zone, x, y))
								...
								MapRoomID(ROOM2)=MapRoomID(ROOM2)+1
							Else
								If MapRoomID(ROOM2C) < MaxRooms And MapName(zone, x, y) = ""  Then
									If MapRoom(zone, ROOM2C, MapRoomID(ROOM2C)) <> "" Then MapName(zone, x, y) = MapRoom(zone, ROOM2C, MapRoomID(ROOM2C))	
								EndIf
								
								If MapTemp(zone, x - 1, y)>0 And MapTemp(zone, x, y + 1)>0 Then
									r = CreateRoom(tempzone, ROOM2C, x * 8, zone * -1000, y * 8, MapName(zone, x, y))
									r\angle = 180
									TurnEntity(r\obj, 0, r\angle, 0)
								ElseIf MapTemp(zone, x + 1, y)>0 And MapTemp(zone, x, y + 1)>0
									r = CreateRoom(tempzone, ROOM2C, x * 8, zone * -1000, y * 8, MapName(zone, x, y))
									r\angle = 90
									TurnEntity(r\obj, 0, r\angle, 0)
								ElseIf MapTemp(zone, x - 1, y)>0 And MapTemp(zone, x, y - 1)>0
							...
							EndIf
						Case 3
							If MapRoomID(ROOM3) < MaxRooms And MapName(zone, x, y) = ""  Then
								If MapRoom(zone, ROOM3, MapRoomID(ROOM3)) <> "" Then MapName(zone, x, y) = MapRoom(zone, ROOM3, MapRoomID(ROOM3))	
							EndIf
							
							r = CreateRoom(tempzone, ROOM3, x * 8, zone * -1000, y * 8, MapName(zone, x, y))
							If (Not MapTemp(zone, x, y - 1)) Then
								TurnEntity(r\obj, 0, 180, 0)
								r\angle = 180
							ElseIf (Not MapTemp(zone, x - 1, y))
						...
						Case 4
							If MapRoomID(ROOM4) < MaxRooms And MapName(zone, x, y) = ""  Then
								If MapRoom(zone, ROOM4, MapRoomID(ROOM4)) <> "" Then MapName(zone, x, y) = MapRoom(zone, ROOM4, MapRoomID(ROOM4))	
							EndIf
							
							r = CreateRoom(tempzone, ROOM4, x * 8, zone * -1000, y * 8, MapName(zone, x, y))
			...
			Repeat
				...
				For x = 0 To MapWidth - 1
					For y = 0 To MapHeight - 1
						...
						Else
							If MapTemp(zone, x, y) = 255 Then
								Color 0,200,0
							Else If MapTemp(zone, x,y)=4 Then
								Color 50,50,255
							Else If MapTemp(zone, x,y)=3 Then
								Color 50,255,255
							Else If MapTemp(zone, x,y)=2 Then
								Color 255,255,50
							Else
								Color 255, 255, 255
							EndIf
				...
				For x = 0 To MapWidth - 1
					For y = 0 To MapHeight - 1
						...
						If MouseX()>i*64 And MouseX()<i*64+32 And MouseY()>y*64 And MouseY()<y*64+32 Then
							Color 255, 0, 0
							Text i * 64 +2, (y) * 64 + 2,MapTemp(zone, x, y) +" "+ MapName(zone, x, y)
						Else
							If MapName(zone, x, y) <> "" Then
								Color 0, 0, 0
								Text i * 64 +2, (y) * 64 + 2,MapTemp(zone, x, y)
							EndIf
						EndIf
					Next
				i = i - 1
		...
		For y = 0 To MapHeight
			For x = 0 To MapWidth
				MapTemp(zone, x, y) = Min(MapTemp(zone, x, y),1)
			Next
		Next
				...
				If MapTemp(zone, x, y) > 0 Then
					...
					For r.Rooms = Each Rooms
						...
						If Int(r\x/8.0)=x And Int(r\z/8.0)=y Then
							...
							If shouldSpawnDoor
								If (x+1)<(MapWidth+1)
									If MapTemp(zone, x + 1, y) > 0 Then
										d.Doors = CreateDoor(r\zone, Float(x) * spacing + spacing / 2.0, zone * -1000, Float(y) * spacing, 90, r, Max(Rand(-3, 1), 0), (zone Mod 2) * 2)
										r\AdjDoor[0] = d
									EndIf
								EndIf
							EndIf
							...
							If shouldSpawnDoor
								If (y+1)<(MapHeight+1)
									If MapTemp(zone, x, y + 1) > 0 Then
										d.Doors = CreateDoor(r\zone, Float(x) * spacing, zone * -1000, Float(y) * spacing + spacing / 2.0, 0, r, Max(Rand(-3, 1), 0), (zone Mod 2) * 2)
										r\AdjDoor[3] = d
									EndIf
								EndIf
							EndIf
...
Function SetRoom(room_name$,room_type%, room_amount%, zone%) ;place a room without overwriting others
	...
	While MapRoom(zone, room_type, pos) <> ""
		If reached Then
			If dir Then
				pos = pos + 1
			Else
				pos = pos - 1
			EndIf
			If pos < 0 Or pos > (room_amount - 1) Then valid = False : Exit
		Else
			pos = pos + posstep
			If (pos > (room_amount - 1)) Or (pos < 0)
				reached = True
				pos = pos - posstep
			EndIf
			If dir Then
	...
	If valid Then
		MapRoom(zone, room_type, pos)=room_name
	Else
